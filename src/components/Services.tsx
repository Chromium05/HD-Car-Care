  ...
  const services = [
    {
      ...
      description:
        "Layanan detailing lengkap dengan pencucian mendalam, pembersihan interior, dan finishing premium untuk tampilan showroom.",
      features: ["Exterior Deep Clean", "Interior Detailing", "Engine Bay Cleaning", "Tire & Rim Care"],
      price: "Mulai dari Rp 150.000",
      image:
        "https://images.unsplash.com/photo-1607860108855-64acf2078ed9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1974&q=80",
    },
    {
      icon: <ShieldIcon size={32} className="text-green-400" />,
      title: "Paint Protection Film",
      description:
        "Film pelindung transparan yang melindungi cat mobil dari goresan, batu kerikil, dan kerusakan lingkungan.",
      features: ["Self-Healing Technology", "UV Protection", "10 Tahun Garansi", "Invisible Protection"],
      price: "Mulai dari Rp 2.500.000",
      image:
        "https://images.unsplash.com/photo-1552519507-da3b142c6e3d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=800",
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1603386329225-868f9b1ee6c9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1969&q=80",
    },
    {
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1534093607318-f025413f49cb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1600880292203-757bb62b4baf?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1974&q=80",
    },
  ]
      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          ...
          <h3 className="text-3xl md:text-4xl font-light text-white mb-6">
            Solusi Lengkap <span className="font-medium text-green-400">Perawatan Mobil</span>
          </h3>
          <p className="text-gray-300 max-w-2xl mx-auto text-lg">
            Kami menyediakan berbagai layanan perawatan mobil premium dengan teknologi terdepan dan tenaga ahli
            berpengalaman.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="bg-neutral-800 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 group border border-neutral-700"
            >
