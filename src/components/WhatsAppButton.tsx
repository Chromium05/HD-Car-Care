  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <a
        ...
        className="relative flex items-center bg-green-500 text-white rounded-full shadow-lg hover:bg-green-600 transition-all duration-300 hover:scale-110 group overflow-hidden"
        onMouseEnter={() => setIsHovered(true)}
        onMouseLeave={() => setIsHovered(false)}
        aria-label="Chat via WhatsApp"
      >
        {/* WhatsApp Logo SVG */}
        <div className="flex items-center justify-center w-14 h-14 relative z-10">
        ...
        <div
          className={`overflow-hidden transition-all duration-300 ease-in-out ${
            isHovered ? "max-w-32 pr-4" : "max-w-0"
          }`}
        >
      ...
      {/* Tooltip for mobile */}
      <div className="absolute bottom-full right-0 mb-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none md:hidden">
